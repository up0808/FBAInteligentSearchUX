...
// FIX: Import the client hooks (useUIState, useActions) directly from the actions file, 
// where they are generated by createAI and exported.
import { useUIState, useActions } from './actions'; 
...
export default function IntelligentSearchChat() {
  ...
  // The type of AI is inferred from the provider context
